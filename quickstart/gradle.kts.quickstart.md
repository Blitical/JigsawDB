## Quickstart guide (Gradle Kotlin DSL)

JigsawDB is published on MavenCentral:<br>
<table>
  <tr>
    <th><a href="../readme.md">Maven</a></th>
    <th><a href="./gradle.quickstart.md">Gradle</a></th>
    <th><b>Gradle (kts)</b></th>
  </tr>
  <tr>
    <td colspan="3">
      <pre lang="kotlin"><code>repositories {
    mavenCentral()
}</code></pre>
    </td>
  </tr>
...
<table>
  ...
  <tr>
    ...
    implementation("dev.blitical:JigsawDB:<!--VERSION-->v1.0.0-beta.13<!--END_VERSION-->")
    annotationProcessor("dev.blitical:JigsawDB:<!--VERSION-->v1.0.0-beta.13<!--END_VERSION-->")
}</code></pre>
    </td>
  </tr>
</table>
...
<br>
... Continue where you left off in the <a href="../readme.md">readme.md</a>
